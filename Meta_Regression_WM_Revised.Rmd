...
if (out_exclude==0) {
    write_csv(reg_all_output, paste0(directory, "\\Results\\Regression_WM\\regression_all_workingmem.csv"))
    write_csv(reg_perf_output, paste0(directory, "\\Results\\Regression_WM\\regression_perf_workingmem.csv"))
    write_csv(reg_rt_output, paste0(directory, "\\Results\\Regression_WM\\regression_rt_workingmem.csv"))
}

if (out_exclude == 1){
    write_csv(reg_all_output, paste0(directory, "\\Results\\Regression_WM\\regression_all_workingmem_outremoved.csv"))
    write_csv(reg_perf_output, paste0(directory, "\\Results\\Regression_WM\\regression_perf_workingmem_outremoved.csv"))
    write_csv(reg_rt_output, paste0(directory, "\\Results\\Regression_WM\\regression_rt_workingmem_outremoved.csv"))
}
```
