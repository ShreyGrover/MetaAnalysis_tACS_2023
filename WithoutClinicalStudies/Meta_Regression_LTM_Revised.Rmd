...
if(out_exclude == 0) {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_LTM/regression_all_longtermmem.csv"))
  write_csv(reg_perf_output, paste0(directory, "/Results/WithoutClinical/Regression_LTM/regression_perf_longtermmem.csv"))

}else {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_LTM/regression_all_longtermmem_outremoved.csv"))
  write_csv(reg_perf_output, paste0(directory, "/Results/WithoutClinical/Regression_LTM/regression_perf_longtermmem_outremoved.csv"))
}
