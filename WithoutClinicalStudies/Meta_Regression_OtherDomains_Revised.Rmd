...
```{r, include = FALSE}
if(out_exclude == 0) {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_exec.csv"))
  write_csv(reg_perf_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_perf_exec.csv"))
  write_csv(reg_rt_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_rt_exec.csv"))
}else {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_exec_outremoved.csv"))
  write_csv(reg_perf_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_perf_exec_outremoved.csv"))
  write_csv(reg_rt_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_rt_exec_outremoved.csv"))
}
```
...
```{r, include = FALSE}
if(out_exclude == 0) {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_att.csv"))
  write_csv(reg_perf_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_perf_att.csv.csv"))
}else {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_att_outremoved.csv"))
  write_csv(reg_perf_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_perf_Att_outremoved.csv"))
}
```
...
```{r, include = FALSE}
if(out_exclude == 0) {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_int.csv"))
  write_csv(reg_perf_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_perf_int.csv"))
}else {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_int_outremoved.csv"))
  write_csv(reg_perf_output, paste0(directory, "//Results/WithoutClinical/Regression_OtherDomains/regression_perf_int_outremoved.csv"))
}
```
...
```{r, include = FALSE}
if(out_exclude == 0) {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_motlearn.csv"))
}else {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_motlearn_outremoved.csv"))
}
```
...
```{r, include = FALSE}
if(out_exclude == 0) {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_motmem.csv"))
}else {
  write_csv(reg_all_output, paste0(directory, "/Results/WithoutClinical/Regression_OtherDomains/regression_all_motmem_outremoved.csv"))
}
```
